...
export default function MobileLayout({
  ...
  return (
    ...
    <div className="min-h-dvh w-full flex items-center justify-center bg-black/90 lg:bg-zinc-900 overflow-hidden">
      ...
      <div className="w-full max-w-[350px] h-dvh lg:h-[95vh] bg-[#151419] text-white relative shadow-xl lg:rounded-3xl lg:border-2 lg:border-zinc-800 overflow-hidden flex flex-col">
